...
Route::middleware(['auth:tenant', 'auth', 'tenantemailverivied', 'throttle', 'isTenantActive', 'isTenantIsMitra'])->prefix('tenant')->group( function () {
    ...
    Route::get('/dashboard/pos/invoice/receipt/download/{id}', [App\Http\Controllers\Auth\Tenant\PosController::class, 'downloadPdf'])->name('tenant.pos.invoice.receipt.download');
