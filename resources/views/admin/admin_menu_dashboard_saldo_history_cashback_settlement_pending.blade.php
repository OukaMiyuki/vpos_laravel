                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Cashback Settlement Pending</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Data Cashback Pending Qris</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-3">History Cashback Qris Pending</h4>
                                ...
                                <table id="basic-table" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Status Settlement</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                                        ...
                                        @foreach ($historyCashback as $cashback)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge bg-soft-warning text-danger">Pending</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
