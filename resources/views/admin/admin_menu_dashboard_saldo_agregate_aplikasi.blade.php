                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Agregate Aplikasi</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Data Insentif Agregate Aplikasi</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1">Rp. <span data-plugin="counterup">@money($agregateSaldoAplikasi->saldo)</span></h3>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-3">History Insentif Agregate Aplikasi</h4>
                                        ...
                                        @foreach ($withdrawals as $wd)
                                            @foreach ($wd->detailWithdraw as $wddt)
                                                <tr>
                                                    ...
                                                    <td class="text-center">@currency($wddt->nominal)</td>
                                                    <td>
                                                        @if ($wd->status == 0)
