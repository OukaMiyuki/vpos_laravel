                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($shoppingCart as $cart)
                                            <tr>
                                                ...
                                                <td>
                                                    <form @if($cart->tipe_barang == "Custom" || $cart->tipe_barang == "Pack") disabled @endif id="qtyform" action="{{ route('kasir.transaction.pending.updateCart') }}" method="post">
                                                        @csrf
    ...
    <div class="modal fade" id="modalAddCustomProduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="px-3" action="{{ route('kasir.transaction.pending.addCart') }}" method="post" id="show">
    ...
    <div class="modal fade" id="modalAddPackProduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="px-3" action="{{ route('kasir.transaction.pending.addCart') }}" method="post" id="show_pack">
