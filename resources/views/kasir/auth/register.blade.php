...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>VPOS User Register | Kasir</title>
                    ...
                    <div class="col-md-9 col-lg-7 col-xl-6">
                        <div class="card bg-pattern">
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="{{ route('kasir.register') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Sudah punya akun?  <a href="{{ route('kasir.login') }}" class="text-white ms-1"><b>Sign In</b></a></p>
                            </div>
                            <!-- end col -->
                        </div>
                        <!-- end row -->
