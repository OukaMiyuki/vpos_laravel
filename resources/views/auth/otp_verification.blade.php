                    ...
                    <div class="card bg-pattern">
                        <div class="card-body">
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">Harap masukkan OTP yang terkirim ke Whatsapp anda untuk melakukan reset password!</p>
                            </div>
                            <form action="{{ route('access.reset.password.OTPVerification') }}" method="POST">
                                @csrf
                                <input type="hidden" class="d-none" name="phone" value="{{$nohp}}">
