                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('marketing.verification.verify') }}" method="POST">
                                ...
                                <div class="row" id="otp">
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <input type="text" class="masukan text-center form-control" name="first" id="first" maxlength="1"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <input type="text" class="masukan text-center form-control" name="second" id="second" maxlength="1"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <input type="text" class="masukan text-center form-control" name="third" id="third" maxlength="1"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <input type="text" class="masukan text-center form-control" name="fourth" id="fourth" maxlength="1"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <input type="text" class="masukan text-center form-control" name="fifth" id="fifth" maxlength="1"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <input type="text" class="masukan text-center form-control" name="sixth" id="sixth" maxlength="1"/>
                                        </div>
                                    </div>
