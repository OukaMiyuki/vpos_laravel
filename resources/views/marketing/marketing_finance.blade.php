                        ...
                        <div class="card-body">
                            ...
                            <div id="cardCollpase1" class="collapse show">
                                <div class="text-center pt-3">
                                    ...
                                    <div class="row mt-3">
                                        <a href=""><button title="Pengaturan akun" type="button" class="btn btn-info waves-effect waves-light">Lihat Data</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="cardCollpase1" class="collapse show">
                                <div class="text-center pt-3">
                                    ...
                                    <div class="row mt-3">
                                        <a href=""><button title="Pengaturan profil toko" type="button" class="btn btn-info waves-effect waves-light">Lihat Data</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="cardCollpase1" class="collapse show">
                                <div class="text-center pt-3">
                                    ...
                                    <div class="row mt-3">
                                        <a href="{{ route('marketing.finance.history_penarikan') }}"><button title="Pengaturan rekening bank" type="button" class="btn btn-info waves-effect waves-light">Lihat Data</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
