                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form @if ($cart->options['size'] == "Custom" || $cart->options['size'] == "Pack") disabled @endif id="qtyform" action="{{ route('tenant.pos.updateCart') }}" method="post">
                                                        ...
                                                        <button @if ($cart->options['size'] == "Custom" || $cart->options['size'] == "Pack") disabled @endif type="submit" class="btn btn-sm btn-success"><span class="mdi mdi-check-bold"></span></button>
                                                    </form>
                                                </td>
                                                    ...
                                                    <td>
                                                        <form id="cartForm" action="{{ route('tenant.pos.addcart') }}" method="post">
                                                            ...
                                                            @if ($stok->product->tipe_barang == "Custom")
                                                                <button id="add_custom_product" data-id="{{ $stok->id }}" data-barcode="{{ $stok->barcode }}" data-pd_name="{{ $stok->product->product_name }}" data-tipe_barang="{{ $stok->product->tipe_barang }}" data-bs-toggle="modal" data-bs-target="#modalAddCustomProduct" class="pos-add-button" type="button">
                                                                    <span class="mdi mdi-plus-box"></span>
                                                                </button>
                                                            @elseif($stok->product->tipe_barang == "Pack")
                                                                <button id="add_pack_product" data-satuan_unit_pack="{{ $stok->product->satuan_unit }}" data-id_pack="{{ $stok->id }}" data-barcode_pack="{{ $stok->barcode }}" data-pd_name_pack="{{ $stok->product->product_name }}" data-price_pack="{{$stok->product->harga_jual}}" data-tipe_barang_pack="{{ $stok->product->tipe_barang }}" data-bs-toggle="modal" data-bs-target="#modalAddPackProduct" class="pos-add-button" type="button">
                                                                    <span class="mdi mdi-plus-box"></span>
                                                                </button>
                                                            @else
