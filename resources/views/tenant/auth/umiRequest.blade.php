    ...
    <table style="border: none;border-collapse: collapse;width:2610pt;">
        <tbody>
            ...
            <tr>
                ...
                <td style="padding:0px;color:black;font-size:13px;font-weight:400;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:middle;border:.5pt solid white;background:#BDD7EE;border-left:none;"><span style="font-size: 14px;">{{ auth()->user()->storeDetail->name }}</span></td>
                <td style="padding:0px;color:black;font-size:13px;font-weight:400;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:middle;border:.5pt solid white;background:#BDD7EE;border-left:none;"><span style="font-size: 14px;">{{ auth()->user()->storeDetail->jenis_usaha }}</span></td>
                <td style="padding:0px;color:black;font-size:13px;font-weight:400;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:middle;border:.5pt solid white;background:#BDD7EE;border-left:none;"><span style="font-size: 14px;">{{ auth()->user()->storeDetail->alamat }}</span></td>
                <td style="padding:0px;color:black;font-size:13px;font-weight:400;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:middle;border:.5pt solid white;background:#BDD7EE;border-left:none;"><span style="font-size: 14px;">{{ auth()->user()->storeDetail->kabupaten }}</span></td>
                <td style="padding:0px;color:black;font-size:13px;font-weight:400;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:middle;border:.5pt solid white;background:#BDD7EE;border-left:none;"><span style="font-size: 14px;">{{ auth()->user()->storeDetail->kode_pos }}</span></td>
            </tr>
        </tbody>
    </table>
