                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="tipe_barang" name="tipe_barang" required>
                                                    ...
                                                    <option @if($product->tipe_barang == "PCS") selected @endif value="PCS">PCS</option>
                                                    <option @if($product->tipe_barang == "Pack") selected @endif value="Pack">Pack</option>
                                                    <option @if($product->tipe_barang == "Custom") selected @endif value="Custom">Custom</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="satuan" data-satuan_barang="{{$product->satuan_barang}}" name="satuan" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="unit" data-satuan_unit="{{$product->satuan_unit}}" name="unit" required>
