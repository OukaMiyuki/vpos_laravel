                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('tenant.transaction.list.pending') }}">Pending</a></li>
                                ...
                                <table id="scroll-horizontal-table-pos" class="table table-bordered border-primary w-100 nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($shoppingCart as $cart)
                                            <tr>
                                                <td>
                                                    <form id="qtyform" action="{{ route('tenant.transaction.pending.deleteCart') }}" method="post">
                                                        @csrf
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($stock as $stok)
                                                <tr>
                                                    <td>{{ $no+=1 }}</td>
                                                    <td>
                                                        <form id="cartForm" action="{{ route('tenant.transaction.pending.addCart') }}" method="post">
                                                            @csrf
    ...
    <div class="modal fade" id="processInvoice" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="px-3" action="{{ route('tenant.pos.transaction.pending.process') }}" method="post">
                    @csrf
