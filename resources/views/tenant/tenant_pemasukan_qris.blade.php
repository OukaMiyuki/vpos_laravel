                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Pemasukan Transaksi Qris</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Data Pemasukan Transaksi Qris</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-3">Tabel Daftar Pemasukan Transaksi Qris</h4>
                            <div class="row">
                                <div class="col-6">

                                </div>
                                <div class="col-6 text-end">
                                    <div id="daterange_transaction_list_qris_finish_tenant" class="float-end" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 50%; text-align:center">
                            ...
                            <br>
                            <table id="basic-datatable" class="table tenant-transaction-list-qris-finish dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Action</th>
