                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Pending Saldo Qris</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Data Pemasukan Pending Qris</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-3">Tabel Data Pemasukan Pending Qris Toko</h4>
